...
class Pangolin(Node):
    ...
    # Down & Curl action mode(left)
        if msg.buttons[6] != self.last_joy_msgs_buttons[6] and self.is_curl == False and (self.is_freedom_mode == False):
    ...
    # Down & Curl action mode(right)
        if msg.buttons[7] != self.last_joy_msgs_buttons[7] and self.is_curl == False and (self.is_freedom_mode == False):
    ...
    # Freedom control mode
        if msg.buttons[3] != self.last_joy_msgs_buttons[3] and (self.is_curl == False):
